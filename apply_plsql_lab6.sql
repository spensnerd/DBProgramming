...
@/home/student/Data/cit325/lab6/apply_prep_lab6.sql

-- Open log file.
SPOOL apply_plsql_lab6.txt

--**************************************************************
-- Test One, no error should be detected.
--**************************************************************
DECLARE
...
-- Call test for the insert_items procedure.
DECLARE
...
--**************************************************************
-- query for results from the call to the insert_item procedure.
--**************************************************************
COL item_barcode FORMAT A10 HEADING "Item|Barcode"
...
--**************************************************************
-- Second test for the insert_items procedure.
--**************************************************************
DECLARE
...
--**************************************************************
-- Query for the second test for the insert_item procedure, the 
-- business rules.
--**************************************************************
COL item_barcode FORMAT A10 HEADING "Item|Barcode"
COL item_title   FORMAT A36 HEADING "Item Title"
...
--**************************************************************
-- Test for what's written to the nc_error table.
--**************************************************************
